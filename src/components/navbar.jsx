...
export default function FixedNav() {
  ...
  const toggleDarkMode = () => {
    ...
    document.querySelector('#navbar').classList.toggle('nav-dark');
    document.querySelector('#navbar').classList.toggle('nav-light');
  };
...
function Nav({ darkMode, toggleDarkMode }) {
  ...
  return (
    <Disclosure as="nav" id="navbar" className="nav-light">
      {({ open }) => (
        <>
